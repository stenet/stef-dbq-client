...
define('framework/dx/services/dx-template-service',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    ...
    var DxTemplateService = (function () {
        ...
        DxTemplateService.prototype.getTemplates = function (bindingContext, overrideContext, resources) {
            var _this = this;
            var result = {};
            var _loop_1 = function (templateKey) {
                result[templateKey] = {
                    render: function (renderData) {
                        return _this.render(_this.templates[templateKey], renderData.container, resources, bindingContext, overrideContext, renderData.model);
                    }
                };
            };
        ...
        DxTemplateService.prototype.render = function (template, container, resources, bindingContext, overrideContext, model) {
            var newItem;
            ...
            if (model) {
                ...
                itemOverrideContext = aurelia_framework_1.createOverrideContext(bindingContext, overrideContext);
            }
            else {
    ...
    var DxWidget = DxWidget_1 = (function () {
        ...
        DxWidget.prototype.extractTemplates = function () {
            ...
            $(this.element)
                ...
                _this.templates[name] = {
                    render: function (renderData) {
                        return _this.dxTemplate.render(item, renderData.container, _this.owningView.resources, _this.bindingContext, _this.overrideContext, renderData.model);
                    }
                };
                $(item).remove();
            });
        ...
        DxWidget.prototype.registerBindings = function () {
            ...
            var _loop_1 = function (property) {
                ...
                this_1.bindingEngine.expressionObserver(this_1.getContext(binding), binding.expression)
                    .subscribe(function (newValue, oldValue) {
        ...
        DxWidget.prototype.getContext = function (binding) {
            var parsed = binding.parsed;
            var obj = parsed;
            while (obj.object) {
                obj = obj.object;
            }
